...
const DifficultySelect: React.FC<DifficultySelectProps> = ({
  ...
  const difficultyInfo = {
    easy: {
      ...
      pointsLabel: "1.0x points",
      description: "Recommended for beginners",
    },
    medium: {
      color: "blue",
      label: "Medium",
      timeLabel: "1 min per question",
      pointsLabel: "1.5x points",
      description: "Recommended default",
    },
    hard: {
      color: "red",
      label: "Hard",
      timeLabel: "30 sec per question",
      pointsLabel: "2.0x points",
        ...
        {availableDifficulties.map((difficulty, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 space-y-1 text-sm text-gray-600 transition-opacity duration-200">
                <p className="transition-all duration-200">{info.timeLabel}</p>
