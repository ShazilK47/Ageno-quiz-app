...
const ProfilePage = () => {
  ...
  // Get MFA status when security tab is active
  useEffect(() => {
  ...
  const handleStartTotpMfa = async () => {
    ...
    try {
      ...
      if ("secretKey" in result) {
        ...
        const otpAuthUrl = result.authenticatorUri;
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-blue-700">
                          Changing your email requires verification. You&apos;ll
                          need to verify your new email address before the
                          change takes effect.
                        </p>
                      </div>
                    </div>
              ...
              {activeTab === "security" && (
                <div>
                  ...
                  <div className="space-y-6">
                    {/* Email Verification Section - existing code... */}
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        <p className="text-gray-600 text-sm mb-4">
                          Add a second layer of security to your account by
                                ...
                                {mfaFactors.map((factor) => (
                                  ...
                                  >
                                    ...
                                    <button
                                      type="button"
                                      onClick={() =>
                                        handleRemoveMfaFactor(factor.uid)
                                      }
                                      disabled={isSubmitting}
                              ...
                              {!totpQrCode ? (
                                <>
                                  <p className="text-sm text-gray-600 mb-4">
                                    ...
                                    Authy to generate verification codes.
                                  </p>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        <p className="text-gray-600 text-sm mb-4">
                          You can request a copy of your personal data or delete
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        <p className="text-gray-600 text-sm mb-4">
                          Review recent security events for your account. This
                          helps you identify any suspicious activity.
                        </p>
